...
export class Register extends Component {
     ...
     */
    formValidation = () => {
        var params = { fields : {}, alert : {type : '', message : ''},formValidated : false  }, 
            { password, passwordConfirm } = this.state.fields;

        for (let field in this.state.fields) {
            let controls = this.state.fields[field];
            controls.isValid = validate(this.state.fields[field].value, this.state.fields[field].rules);
            if(controls.isValid){
        ...
        return (
            <Row className="justify-content-md-center" style={{ marginTop:"10%"}}>
                <Col md="6" className="shadow-sm p-3 mb-5 bg-light rounded">
                    <h1>User register</h1>
                    <Form validated={this.state.formValidation}  onSubmit={ this.handleSubmit }>
                        ...
                        <Form.Row>
                            ...
                            <InputText 
                                controlId={this.state.fields.dedication.controlId}
                                label={this.state.fields.dedication.label}
                                name="dedication" 
                                onChange={ this.handleChange }
                                placeholder="teacher"
                                type="text" 
                                isTouched = {this.state.fields.dedication.isTouched}
                        ...
                        <Form.Row>
                            ...
                            <InputText 
                                controlId={this.state.fields.birthdate.controlId}
                                label={this.state.fields.birthdate.label}
                                name="birthdate" 
                                onChange={ this.handleChange }
                                placeholder="1989-07-25"
                                type="text" 
                                isTouched = {this.state.fields.birthdate.isTouched}
                         ...
                         <Form.Row>
                            ...
                            <InputText 
                                controlId={this.state.fields.passwordConfirm.controlId}
                                label={this.state.fields.passwordConfirm.label}
                                name="passwordConfirm" 
                                onChange={ this.handleChange }
                                placeholder="Confirm Password"
                                type="password" 
                                isTouched = {this.state.fields.passwordConfirm.isTouched}
                                isValid = {this.state.fields.passwordConfirm.isValid} />
                        </Form.Row>
